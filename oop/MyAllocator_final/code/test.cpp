...
{	
	...
	std::cout << "MyAllocator" <<" allocator: "<< (clock() - start) * 1.0 / CLOCKS_PER_SEC << " seconds"<< std::endl;
	start = clock();
	//test resize
	for (int i = 0; i < 100; i++)
	{
	...
	std::cout << "MyAllocator" <<" resize: "<< (clock() - start) * 1.0 / CLOCKS_PER_SEC << " seconds"<< std::endl;
	start = clock();
	//test assignment
	...
	std::cout << "MyAllocator" <<" assignment: "<< (clock() - start) * 1.0 / CLOCKS_PER_SEC << " seconds"<< std::endl;
